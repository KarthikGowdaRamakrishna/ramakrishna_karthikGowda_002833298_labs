...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSearchFeature = new javax.swing.JButton();
        ...
        btnSearchFeature.setText("Search Feature");
        btnSearchFeature.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSearchFeatureActionPerformed(evt);
            }
        });
    ...
    private void saveFeatures() {
       ...
       for(int i=0; i < model.getRowCount();i++){
           ...
           if(supplier.getProductCatalog().getFeatureList().size() == 0 ){
               supplier.getProductCatalog().setFeatureList(currentFeature);
           }else{
           for(Feature feature:supplier.getProductCatalog().getFeatureList()){
               if(!feature.getName().equalsIgnoreCase(currentFeature.getName())) {
                   supplier.getProductCatalog().setFeatureList(currentFeature);
                   System.out.println("ui.supplier.ViewProductDetailJPanel.saveFeatures()");
                   break;
               }    
           }
           }
           System.out.println(currentFeature.getName() + "/n" + currentFeature.getValue());
       }
       System.out.println(supplier.getProductCatalog().getFeatureList().toString()+ "/n");
    }
    ...
    private void btnSearchFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchFeatureActionPerformed
        // TODO add your handling code here:
        SearchForFeatureJPanel vpdjp = new SearchForFeatureJPanel(workArea, product, supplier);
        workArea.add("ViewProductDetailJPanel",vpdjp);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    }//GEN-LAST:event_btnSearchFeatureActionPerformed
    ...
    private javax.swing.JButton btnSearchFeature;
